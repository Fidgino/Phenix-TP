...
let input = document.querySelector("input.bouton")
let mail = document.querySelector("input#text_imput_1")
let manyWeek = document.querySelector("input#text_imput_2")
let manyPeople = document.querySelector("input#text_imput_3")
...
input.onclick = () => {
    ...
    window.open(`./confirmation.html?id=${id}&mail=${mail.value}&manyw=${manyWeek.value}&manyp=${manyPeople.value}`)
}